...
`eebook-portfolio` — микросервис для работы с активами пользователей (портфелями) в проекте eebook

---

## 🔗 Документация

Полная документация доступна здесь: [docs](https://macalistervadim.github.io/eebook-portfolio/)
